...
def main() -> None:
    parser = argparse.ArgumentParser(description="Extract advanced features (Adaptive ROI + Art-Box + Whitening).")
    parser.add_argument("--data-dir", default="data/training")
    parser.add_argument("--output-base", default="models/advanced_features")
    parser.add_argument("--image", default=None)
    parser.add_argument("--output-csv", default=None)
    args = parser.parse_args()

    if args.image:
        out = args.output_csv or "models/_single_advanced_features.csv"
